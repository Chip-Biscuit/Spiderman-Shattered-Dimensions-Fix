...
void PerformHexEdit1(LPBYTE lpAddress, DWORD moduleSize) {
    ...
    std::vector<HexEdit5> edits5 = {
        // FPS uncap 120 fps
        { { 0x89, 0x88, 0x88, 0x3C }, { 0x23, 0x87, 0x08, 0x3C }, 0 },
    };
...
void PerformHexEdits1() {
    ...
    PerformHexEdit1(lpAddress, moduleSize);
}
